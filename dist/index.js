...
class AppIntroSlider extends React.Component {
    ...
    _renderNextButton = () => this.props.showNextButton &&
        this._renderButton('Next', this.props.nextLabel, this.props.onNext, this.props.renderNextButton);
    _renderPrevButton = () => this.props.showPrevButton &&
        this._renderButton('Prev', this.props.prevLabel, this.props.onNext, this.props.renderPrevButton);
    _renderDoneButton = () => this.props.showDoneButton &&
    ...
    render() {
        ...
        const extra = (0, merge_extradata_1.default)(extraData, this.state.width);
